...
double To;
int Vo = 0;
bool filamentSensorEnable = true; //filament sensor enabled
int temperatureMax;
double Kp;
double Ki;
double Kd;
...
void saveConfiguration(bool reset=true) {
  ...
  doc["To"] = To;
  doc["Vo"] = Vo;
  doc["filamentSensorEnable"] = filamentSensorEnable;
...
void loadConfiguration(bool reset=false) {
  ...
  Vo = doc["Vo"] | 40;
  //Vo = Vco;
  filamentSensorEnable = doc["filamentSensorEnable"];
  temperatureMax = doc["temperatureMax"] | 230;
  ...
  Serial.println("filamentSensorEnable:Filament enabled");
  Serial.println("temperatureMax:Maximum Temperature");
